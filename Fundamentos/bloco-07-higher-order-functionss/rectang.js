...
// Dado o código abaixo, altere a chamada da função rectangleArea de forma que seja impressa a área dos 3 retângulos 
//(rectangle1, rectangle2 e rectangle3).
...
const alex = {
  ...
  const filtersPeople = people.filter((element) => element.bornIn === 1901);
  const filterPeoples = people.filter((element) => element.bornIn === 1992);
  
  console.log(filtersPeople);
...
//   Cada chave do objeto é uma estação, e o valor de cada chave é um array
//    de strings que representa os meses daquela estação.
//     A partir desse objeto, desestruture as estações do ano e espalhe-as 
//     em um array de meses do ano.
